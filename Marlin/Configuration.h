...
#define STRING_CONFIG_H_AUTHOR "Sermoon V1" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sermoon V1"
...
#define TEMP_RESIDENCY_TIME     3//10  // (seconds) Time to wait for hotend to "settle" in M109
#define TEMP_WINDOW              3//1  // (°C) Temperature proximity for the "temperature reached" timer
#define TEMP_HYSTERESIS          6//3  // (°C) Temperature proximity considered "close enough" to the target

#define TEMP_BED_RESIDENCY_TIME 3//10  // (seconds) Time to wait for bed to "settle" in M190
#define TEMP_BED_WINDOW          3//1  // (°C) Temperature proximity for the "temperature reached" timer
#define TEMP_BED_HYSTERESIS      6//3  // (°C) Temperature proximity considered "close enough" to the target
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define DEFAULT_Kd 54.55
  
  /* Sermoon V1 */
  // #define DEFAULT_Kp 37.81
  // #define DEFAULT_Ki 2.85//6.85
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  /* Sermoon V1 */
  // #define DEFAULT_bedKp 140.39
  // #define DEFAULT_bedKi 14.42//27.42
  // #define DEFAULT_bedKd 479.21
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 425 }//{ 80, 80, 400, 407 }
...
/**
 * support wifi board or not
 * 1:support, 0:not
 */
#define WIFI_BOARD_SUPPORT        1
...
#define FIRMWARE_TYPE                       FIRTYPE_SERMOONV1_MOD
  ...
  #define SOFTVERSION                         "Ver 1.0.33"
  // #define SCREENVERSION                       "Ver 1.0.6"
  #define ENABLE_MATERIAL_CHECK               1                   /* 1: enable material check, 0: disable material check   */
  #define ENABLE_DOOR_OPEN_CHECK              0                   /* 1: enable door-open check, 0: disable door-open check */
#elif FIRMWARE_TYPE == FIRTYPE_SERMOONV1_PRO
  #define MACHINE_NAME_DWIN                   "Sermoon V1 Pro"
  #define HARDWAREVERSION                     "V200"
